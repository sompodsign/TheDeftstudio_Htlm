        ...
        venobox: function(options) {
            ...
            return this.each(function() {
                ...
                function checknav(){
                    ...
                    if (!thenext.length && infinigall !== true  || items.index(obj) == 5 || items.index(obj) == 8 || items.index(obj) == 17 || items.index(obj) == 14) {
                    ...
                    // alert(items.index(obj))
                    if ((items.index(obj) > 0 || infinigall === true) && items.index(obj) != 6 && items.index(obj) != 9&& items.index(obj) != 15) {
